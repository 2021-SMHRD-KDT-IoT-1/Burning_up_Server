...
ALTER TABLE FRXT_CHCK ADD CONSTRAINT PK_FRXT_CHCK PRIMARY KEY (
	CHCK_NUM
);
ALTER TABLE FRXT_CHCK ADD CONSTRAINT FK_FRXT_INFO_TO_FRXT_CHCK_1 FOREIGN KEY (
	F_NICK
)
REFERENCES FRXT_INFO (
	F_NICK
);
ALTER TABLE FRXT_CHCK ADD CONSTRAINT FK_FRXT_INFO_TO_FRXT_CHCK_2 FOREIGN KEY (
	NFC_NUM
)
REFERENCES FRXT_INFO (
	NFC_NUM
...
ALTER TABLE FRXT_AGN ADD CONSTRAINT PK_FRXT_AGN PRIMARY KEY (
	AGN_NUM
);
ALTER TABLE FRXT_AGN ADD CONSTRAINT FK_FRXT_INFO_TO_FRXT_AGN_1 FOREIGN KEY (
	NFC_NUM
)
REFERENCES FRXT_INFO (
	NFC_NUM
);
CREATE sequence AGN_NUM
start with 1
increment by 1;
...
CREATE TABLE FRXT_PRE (
	...
	NFC_NUM	NUMBER	NOT NULL,
	PRE_VALUE	NUMBER	NOT NULL
);
ALTER TABLE FRXT_PRE ADD CONSTRAINT PK_FRXT_PRE PRIMARY KEY (
	PRE_NUM
);
ALTER TABLE FRXT_PRE ADD CONSTRAINT FK_FRXT_INFO_TO_FRXT_PRE_1 FOREIGN KEY (
	NFC_NUM
)
REFERENCES FRXT_INFO (
	NFC_NUM
);
CREATE sequence PRE_NUM
start with 1
increment by 1;
---------------------------------------------------------------------------------------------------------------------
-- 테이블 확인
...
drop sequence CHCK_NUM;
drop sequence AGN_NUM;
drop sequence PRE_NUM;
